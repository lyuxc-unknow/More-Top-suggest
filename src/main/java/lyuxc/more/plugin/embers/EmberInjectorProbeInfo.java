...
public class EmberInjectorProbeInfo implements IProbeInfoProvider {
    @Override
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) {
        if (world.getTileEntity(data.getPos()) instanceof TileEntityEmberInjector) {
            ...
            int max = (int) tileEntityEmberInjector.capability.getEmberCapacity();
            int ember = (int) tileEntityEmberInjector.capability.getEmber();
