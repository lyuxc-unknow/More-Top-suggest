...
public class BeamCannonProbeInfo implements IProbeInfoProvider {
    @Override
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) {
        if (world.getTileEntity(data.getPos()) instanceof TileEntityBeamCannon) {
            ...
            int max = (int) tileEntityBeamCannon.capability.getEmberCapacity();
            int ember = (int) tileEntityBeamCannon.capability.getEmber();
