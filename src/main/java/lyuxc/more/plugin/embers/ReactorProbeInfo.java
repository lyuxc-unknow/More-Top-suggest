...
public class ReactorProbeInfo implements IProbeInfoProvider {
    @Override
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) {
        if (world.getTileEntity(data.getPos()) instanceof TileEntityReactor) {
            ...
            int max = (int) tileEntityReactor.capability.getEmberCapacity();
            int ember = (int) tileEntityReactor.capability.getEmber();
