...
public class PowerProbeInfo implements IProbeInfoProvider {
    @Override
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) {
        if (world.getTileEntity(data.getPos()) instanceof TileEntityCopperCell) {
            ...
            int max = (int) tileEntityCopperCell.capability.getEmberCapacity();
            int ember = (int) tileEntityCopperCell.capability.getEmber();
