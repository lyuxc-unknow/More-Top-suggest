...
public class CinderPlinthProbeInfo implements IProbeInfoProvider {
    @Override
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) {
        if (world.getTileEntity(data.getPos()) instanceof TileEntityCinderPlinth) {
            ...
            int max = (int) tileEntityCinderPlinth.capability.getEmberCapacity();
            int ember = (int) tileEntityCinderPlinth.capability.getEmber();
